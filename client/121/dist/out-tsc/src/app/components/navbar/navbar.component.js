...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(auth, location, element, router) {
        this.auth = auth;
    ...
    NavbarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [authentication_service_1.AuthenticationService, common_1.Location, core_1.ElementRef, router_1.Router])
    ], NavbarComponent);
